...
use crate::assets::{Anchor, SpriteId, SpriteImage, SpriteManager, TextureId};
...
impl Animation {
    ...
    pub fn with_constant_delay(
        ...
        Self::new(
            sprites
                .into_iter()
                .map(|&sprite| Frame { sprite, duration })
                .collect(),
            can_interrupt,
            should_loop,
        )
...
impl AnimationManager {
    ...
    /// are laid out
    pub fn standard_character_animations(
        fps: usize,
        ...
        AnimationManager {
            ...
            idle: animation(
                ...
                0..3,
                false,
                &[ms_to_frames(640), ms_to_frames(80)],
                true,
                true,
            ),
            victory: animation(
